...
// {
//     bool keepSolving = 1;
//     double a1 = NAN, b1 = NAN, c1 = NAN;
//     double a2 = NAN, b2 = NAN, c2 = NAN;
//     double x1 = NAN, x2 = NAN;

//     while (keepSolving)
//     {
//         if (readCoeficientsFromEquation(&a1, &b1, &c1) == 1)
//         {
//             continue;
//         }
//         if (readCoeficientsFromEquation(&a2, &b2, &c2) == 1)
//         {
//             continue;
//         }

//         int nRoots = solveQuadraticEquation(a1 - a2, b1 - b2, c1 - c2, &x1, &x2);

//         printRoots(nRoots, x1, x2);

//         if (askAboutChoise("Do you want see graphic"))
//         {
//             drawAnimationTwoGraph(-a1 / 2, -b1 / 2, -c1 / 2, -a2 / 2, -b2 / 2, -c2 / 2);
//             TwoPlotQuadratics(a1 / 2, b1 / 2, c1 / 2, a2 / 2, b2 / 2, c2 / 2, x1, x2);
//         }
